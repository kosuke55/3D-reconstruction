...
callback(std_msgs::Int64 num)
{
    ...
    if (pcd_index > 1){
        ...
        filename1 = "/home/kosuke/catkin_ws/src/scanner/data/" + std::to_string(pcd_index-1) + ".pcd";
        ...
        filename2 = "/home/kosuke/catkin_ws/src/scanner/data/" + std::to_string(pcd_index) + ".pcd";
